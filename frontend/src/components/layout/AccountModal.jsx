...
const AccountModal = ({ openState, handleClose }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed z-50 top-0 right-0 h-full w-80 bg-white shadow-lg transform transition-transform duration-300 ${
      ...
      >
        <div className="p-6 flex flex-col h-full justify-center items-center">
          ...
          <button
            className="mt-4 px-4 py-0 text-red-500 hover:text-red-700"
          ...
          <button
            className="mt-auto mr-auto px-4 py-0 text-red-500 hover:text-red-700"
            onClick={handleClose}
          >
            Close
          </button>
